...
// niveau d'expérience
export const niveauxExperience = [
  "Étudiant en Droit",
  "Junior (0-2 ans)",
  "Confirmé (3-7 ans)",
  "Senior (8-15 ans)",
...
export const formationsJuridiques = [
  "Licence en Droit",
  "Master 1 Droit",
  "Master 2 Droit",
...
export const modesTravailRecherche = ["Sur site", "Télétravail", "Hybride"];

// domaines d'expérience
export const domainesExperience = [
  "Banque & Finance",
