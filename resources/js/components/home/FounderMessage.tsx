                    ...
                    <Reveal direction="right" duration={1} delay={0.2} className="space-y-8 lg:col-span-7">
                        <div>
                            ...
                            <p className="mt-3 text-sm leading-relaxed font-light text-[#C06041] md:text-base">
                                Expert juridique, ex-Directeur juridique de holdings au Maroc et en Afrique. Président élu de l'Association marocaine des juristes d'entreprise — AMJE (en cours de constitution). Fondateur de Sentissi Legal Advisory.
                            </p>
                        </div>
