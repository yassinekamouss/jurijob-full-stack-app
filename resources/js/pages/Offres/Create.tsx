...
export default function Create({ taxonomies }: Props) {
    ...
    return (
        <div className="relative min-h-screen overflow-x-hidden bg-[#FDFCF8] text-[#1a1f1e]">
            ...
            <main className="relative z-10 mx-auto max-w-6xl px-4 pt-28 pb-12 sm:px-6 lg:px-8">
                <motion.div
                ...
                >
                    ...
                    <p className="mx-auto max-w-xl text-lg font-medium text-[#1a1f1e]/50 leading-relaxed">
                        Définissez votre besoin avec précision et laissez nos consultants experts faire le reste.
                    </p>
                </motion.div>
                ...
                <div className="relative">
                    ...
                    <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        <motion.div
                            ...
                            className="overflow-hidden bg-white/50 shadow border border-[#1a1f1e]/5 lg:col-span-8"
                        >
                        ...
                        {/* Expert Advice Side Card - Displayed on ALL steps */}
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            className="w-full lg:col-span-4 lg:sticky lg:top-32"
                        >
                ...
                <div className="mt-12 text-center opacity-40 hover:opacity-100 transition-opacity">
                    <p className="text-sm font-bold text-[#1a1f1e]">
                        Besoin d'aide ? <a href="mailto:[EMAIL_ADDRESS]" className="underline decoration-2 underline-offset-4">recrutement@sentissilegal.com</a>
                    </p>
                </div>
            </main>
        </div>
