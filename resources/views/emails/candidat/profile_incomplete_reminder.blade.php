{{-- resources/views/emails/candidat/profile_incomplete_reminder.blade.php --}}
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8" />
  ...
  <title>Complétez votre profil Jurijob pour maximiser vos chances !</title>
  <style type="text/css">
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td align="center" style="padding-bottom:18px;">
                  <img src="{{ config('app.email_asset_url', config('app.url')) }}/images/logo_jurijob.webp" width="52" height="52" alt="JuriJob"
        ...
        <tr>
          <td class="body-cell" style="padding:40px 48px 32px;color:#1A1F1E;font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:15px;line-height:1.7;">
            ...
            <p style="margin:0 0 24px;color:#475569;font-size:15px;">
              Nous avons remarqué que votre profil JuriJob n'est pas encore complet.
              Pour augmenter vos chances d'être sélectionné(e) par nos recruteurs, il est essentiel de renseigner les informations clés de votre parcours.
            </p>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" width="100%"
              ...
              @foreach ([
                ...
                'Les postes que vous recherchez',
                'Vos spécialisations en droit'
              ] as $item)
              <tr>
                <td style="padding:8px 18px;border-top:1px solid #F1F5F9;">
                  <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td style="font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:13px;font-weight:700;color:#1A1F1E;">
                        &bull; {{ $item }}
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td style="border-left:3px solid #C06041;padding:12px 18px;background-color:#FDF7F5;border-radius:0 6px 6px 0;">
                  <span style="font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:13px;color:#475569;line-height:1.6;">
                    Un profil complet est <strong style="color:#C06041;">5 fois plus susceptible</strong> d'attirer l'attention des cabinets et entreprises qui recrutent sur JuriJob.
                  </span>
                </td>
              </tr>
            </table>
              ...
              <tr>
                <td align="center">
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;">
                    <tr>
                      <td align="center" bgcolor="#1A1F1E" class="btn-cell"
                          style="border-radius:6px;padding:15px 36px;background-color:#1A1F1E;">
