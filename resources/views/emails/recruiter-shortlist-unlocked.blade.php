{{-- resources/views/emails/recruiter-shortlist-unlocked.blade.php --}}
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8" />
  ...
  <title>Votre shortlist complète est disponible — JuriJob</title>
  <style type="text/css">
        ...
        <tr>
          <td class="body-cell" style="padding:40px 48px 32px;color:#1A1F1E;font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:15px;line-height:1.7;">
            ...
            <p style="margin:0 0 24px;color:#475569;font-size:15px;">
              Excellente nouvelle ! Votre paiement a été confirmé. La shortlist complète pour la mission <strong style="color:#1A1F1E;">{{ $offre->titre ?? $offre->poste?->label ?? '—' }}</strong> est à présent <strong style="color:#C06041;">entièrement disponible</strong>.
            </p>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" width="100%"
              ...
              @foreach ([
                ...
                ['Profils débloqués', ($shortlistCount ?? 0) . ' candidat(s)'],
                ['Accès valable jusqu\'au', $accessExpiryDate ?? '—'],
                ['Statut', 'Accès Illimité'],
              ] as [$label, $value])
              <tr>
              ...
              <tr>
                <td style="border-left:3px solid #C06041;padding:12px 18px;background-color:#FDF7F5;border-radius:0 6px 6px 0;">
                  <span style="font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:13px;color:#475569;line-height:1.6;">
                    Vous pouvez contacter directement les candidats sélectionnés ou télécharger leurs dossiers depuis votre tableau de bord.
                  </span>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:0 0 4px;font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:13px;color:#64748B;">
              Besoin d'accompagnement juridique supplémentaire ? Contactez notre pôle conseil : <a href="mailto:{{ config('jurijob.support_email') }}" style="color:#C06041;text-decoration:none;">{{ config('jurijob.support_email') }}</a>
            </p>
