{{-- resources/views/emails/recruiter-request-confirmed.blade.php --}}
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8" />
  ...
  <title>Demande enregistrée — Recherche en cours – JuriJob</title>
  <style type="text/css">
        ...
        <tr>
          <td class="body-cell" style="padding:40px 48px 32px;color:#1A1F1E;font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:15px;line-height:1.7;">
            ...
            <p style="margin:0 0 24px;color:#475569;font-size:15px;">
              Nous avons bien enregistré votre besoin en recrutement pour la mission <strong style="color:#1A1F1E;">{{ $offre->titre ?? $offre->poste?->label ?? '—' }}</strong>. Nos juristes recruteurs ont démarré le processus de matching sur notre vivier qualifié.
            </p>
              ...
              <tr>
                <td style="border-left:3px solid #C06041;padding:12px 18px;background-color:#FDF7F5;border-radius:0 6px 6px 0;">
                  <span style="font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:13px;color:#475569;line-height:1.6;">
                    <strong style="color:#C06041;">Engagement Qualité 48h :</strong> Notre équipe s'engage à constituer et vous délivrer une shortlist ciblée sous <strong style="color:#C06041;">48 heures maximum</strong>.
                  </span>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:0 0 4px;font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:13px;color:#64748B;">
              Une question ? Contactez notre équipe : <a href="mailto:{{ config('jurijob.support_email') }}" style="color:#C06041;text-decoration:none;">{{ config('jurijob.support_email') }}</a>
            </p>
