...
<div class="w-full flex-1 pb-16 sm:pb-24 pt-6 sm:pt-12">
    ...
    <section class="relative py-8 sm:py-12 lg:py-16">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 border border-[#C06041]/20 bg-[#C06041]/5 px-3 sm:px-4 py-1.5 text-[11px] sm:text-xs font-semibold tracking-wider text-[#C06041] uppercase mb-4">
    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 space-y-12 sm:space-y-24">
        <!-- Offre principale: Split-Layout (7 cols / 5 cols) -->
        <section class="relative">
            <div class="mb-6 sm:mb-8 border-b border-[#1a1f1e]/10 pb-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start">
                ...
                <div class="lg:col-span-7 space-y-6">
                    <div class="border border-[#1a1f1e]/10 bg-[#FDFCF8] p-5 sm:p-8 space-y-6">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <h3 class="text-xl sm:text-2xl font-normal text-[#1a1f1e]" style="font-family: 'Cormorant Garamond', serif;">
                        ...
                        <p class="text-sm sm:text-base font-light leading-relaxed text-[#1a1f1e]/80">
                            {{ __t('services_page.main_offer.description') }}
                        </p>

                        <div class="flex items-start gap-3 border-y border-[#1a1f1e]/10 py-4 text-xs sm:text-sm text-[#1a1f1e]/85 font-light bg-[#1a1f1e]/[0.02] px-3.5 sm:px-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                            <div class="border border-[#1a1f1e]/10 p-3.5 bg-[#FDFCF8]">
                                <div class="font-semibold text-xs text-[#1a1f1e] flex items-center gap-1.5">
                                    <svg class="h-3.5 w-3.5 text-[#C06041] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="lg:col-span-5 relative mt-4 lg:-mt-2">
                    <div class="border-2 border-[#1a1f1e] bg-[#FDFCF8] p-6 sm:p-8 shadow-xl relative z-10 space-y-6">
                        ...
                        <div>
                            <div class="text-3xl sm:text-4xl font-bold text-[#1a1f1e] tracking-tight">
        ...
        <section class="relative pt-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
                ...
                <div class="lg:col-span-7 border border-[#C06041]/30 bg-[#FDFCF8] p-5 sm:p-8 space-y-4 relative overflow-hidden group hover:border-[#C06041]/60 transition-colors">
                    <div class="flex items-center justify-between gap-2">
                        <div class="flex h-10 w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center bg-[#C06041]/10 text-[#C06041]">
                            <svg class="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                            </svg>
                        </div>
                        <span class="text-[11px] sm:text-xs font-medium uppercase tracking-wider text-[#C06041] bg-[#C06041]/10 px-2.5 py-1">
                ...
                <div class="lg:col-span-5 border border-[#1a1f1e]/10 bg-[#FDFCF8] p-5 sm:p-8 space-y-4 hover:border-[#1a1f1e]/30 transition-colors">
                    <div class="flex h-10 w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center bg-[#C06041]/10 text-[#C06041]">
                        <svg class="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="lg:col-span-7 border border-[#1a1f1e]/10 bg-[#FDFCF8] p-5 sm:p-8 space-y-4 hover:border-[#1a1f1e]/30 transition-colors">
                    <div class="flex h-10 w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center bg-[#C06041]/10 text-[#C06041]">
                        <svg class="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Banner CTA contact -->
        <div class="mt-12 sm:mt-16 border-y border-[#1a1f1e]/10 bg-[#FDFCF8] p-6 sm:p-12 text-center">
            <div class="max-w-2xl mx-auto space-y-4">
                <h3 class="text-2xl sm:text-4xl font-normal text-[#1a1f1e]" style="font-family: 'Cormorant Garamond', serif;">
                ...
                <div class="pt-2">
                    <a href="mailto:recrutement@sentissilegal.com" class="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-[#1a1f1e] px-7 py-3.5 text-sm font-medium text-[#FDFCF8] transition-colors hover:bg-[#343a38]">
                        <svg class="h-4 w-4 text-[#C06041]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
