        ...
        <details class="lg:hidden mb-8 border border-[#1a1f1e]/10 bg-[#FDFCF8] p-4 shadow-sm group">
            <summary class="flex cursor-pointer items-center justify-between font-medium text-[#1a1f1e] select-none text-sm">
                <span class="flex items-center gap-2" style="font-family: 'Cormorant Garamond', serif;">
                    ...
                    <span class="text-base font-semibold">{{ __t('cgu_page.sidebar.title') }}</span>
                </span>
                ...
                <section id="article-1" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art1.title') }}</h2>
                        </div>
                    </div>
                ...
                <section id="article-2" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art2.title') }}</h2>
                        </div>
                    </div>

                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="border border-[#1a1f1e]/15 bg-[#FDFCF8] p-4 sm:p-5 space-y-2">
                ...
                <section id="article-3" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art3.title') }}</h2>
                        </div>
                    </div>
                ...
                <section id="article-4" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art4.title') }}</h2>
                        </div>
                    </div>
                ...
                <section id="article-5" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art5.title') }}</h2>
                        </div>
                    </div>
                ...
                <section id="article-6" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art6.title') }}</h2>
                        </div>
                    </div>
                ...
                <section id="article-7" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art7.title') }}</h2>
                        </div>
                    </div>
                    ...
                    <div class="border-l-4 border-[#C06041] border-y border-r border-[#1a1f1e]/15 bg-[#1a1f1e] p-4 sm:p-6 text-[#FDFCF8] shadow-md">
                        ...
                        <p class="mt-2 text-sm sm:text-lg font-medium leading-relaxed">
                ...
                <section id="article-8" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art8.title') }}</h2>
                        </div>
                    </div>
                ...
                <section id="article-9" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art9.title') }}</h2>
                        </div>
                    </div>
                ...
                <section id="article-10" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art10.title') }}</h2>
                        </div>
                    </div>
                ...
                <section id="article-11" class="scroll-mt-28 space-y-6">
                    <div class="flex items-start sm:items-center gap-3 border-b border-[#1a1f1e]/10 pb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-xl font-normal text-[#1a1f1e] sm:text-3xl" style="font-family: 'Cormorant Garamond', serif;">{{ __t('cgu_page.articles.art11.title') }}</h2>
                        </div>
                    </div>
